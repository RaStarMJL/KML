<template>
	<view class="register-container">
		...
		<scroll-view scroll-y class="content-wrapper" :scroll-top="scrollTop">
			...
			<!-- 注册表单 -->
			<view class="register-box" :class="{ 'register-box-keyboard-open': isKeyboardOpen }">
				<view class="input-group">
					...
					<view class="input-item" :class="{ 'active': activeInput === 'confirmPassword' }">
						<uni-icons type="locked" size="20" color="#666"></uni-icons>
						<input 
							type="password" 
					...
					<view class="input-item verification-code" :class="{ 'active': activeInput === 'code' }">
				...
				<view class="agreement">
					<checkbox :checked="agreed" @click="toggleAgreement" color="#2B58F9" style="transform:scale(0.7)" />
					<text class="agreement-text">我已阅读并同意<text class="link">《用户协议》</text>和<text class="link">《隐私政策》</text></text>
				</view>
				
				<button class="register-btn" @click="handleRegister" hover-class="btn-hover" :disabled="!agreed">
					注册
				</button>
