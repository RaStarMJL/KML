	...
	<view class="note-container">
		...
		<view class="search-box" v-if="showSearch">
			...
			<input 
				...
				@confirm="searchNotes"
			/>
			<uni-icons v-if="searchText" type="clear" size="18" color="#999" @click="clearSearch"></uni-icons>
		</view>
		...
		<scroll-view scroll-y class="note-list">
				...
				<view class="note-content">
					...
					<view class="note-footer">
						...
						<view class="note-actions">
							<uni-icons type="more-filled" size="18" color="#999" @click.stop="showActions(note, index)"></uni-icons>
						</view>
					</view>
				</view>
			</view>
			...
			<view v-if="filteredNotes.length === 0" class="empty-state">
				<image class="empty-image" src="/static/images/empty-notes.png" mode="aspectFit"></image>
